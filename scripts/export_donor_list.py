...
def _md(board: pd.DataFrame) -> str:
    ...
    lines = [
        ...
        "for easy Neon entry; reception_draft sheet lists the 34 FST sponsors plus HH's",
        f"30 largest living 5-year donors and hand-picked reception invites.*",
        "",
    ...
    lines += [
        ...
        "top-30-donor ranking excludes internal house accounts (e.g. the cash-drawer",
        "transactions account), which are not real households.*",
        "",
